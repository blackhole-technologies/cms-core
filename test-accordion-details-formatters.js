...
const accordionChecks = [
  ...
  { check: 'Has 3 sections', test: (accordionHtml.match(/field-group-accordion-section/g) || []).length === 3 },
  { check: 'Has header buttons', test: (accordionHtml.match(/field-group-accordion-header/g) || []).length === 3 },
  { check: 'Has panels', test: (accordionHtml.match(/field-group-accordion-panel/g) || []).length === 3 },
...
const detailsChecks = [
  ...
  { check: 'Contains all 3 fields', test: detailsHtml.includes('field_email') && detailsHtml.includes('field_phone') && detailsHtml.includes('field_address') },
