...
import * as aiAgents from '../src/core/ai/ai-agents.ts';
import * as aiProviderManager from '../src/core/ai/ai-provider-manager.ts';
import * as aiRegistry from '../src/core/ai/ai-registry.ts';
import * as aiStats from '../src/core/ai/ai-stats.ts';
...
import * as activity from '../src/core/observability/activity.ts';
import * as analytics from '../src/core/observability/analytics.ts';
import * as audit from '../src/core/observability/audit.ts';
import * as status from '../src/core/observability/status.ts';
import * as watcher from '../src/core/observability/watcher.ts';
import * as template from '../src/core/rendering/template.ts';
import * as themeSettings from '../src/core/rendering/theme-settings.ts';
